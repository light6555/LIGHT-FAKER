...
message: { "imageMessage": { "mimetype": "image/jpeg","caption": `🥀Guillermo`, 'jpegThumbnail': fs.readFileSync('./src/help.jpg')}}
}
contextInfo: {
mentionedJid: [sender]}
const fdoc = {
...
participant: `0@s.whatsapp.net`, ...(from ?
{ remoteJid: "status@broadcast" } : {}) },
message: { "documentMessage": { "title":"🔥Guillermo Canal By Traxnox💓", 'jpegThumbnail': fs.readFileSync('./src/fake.jpg')}}
}
contextInfo: {
mentionedJid: [sender]}
const floc = {
...
mentionedJid: [sender]}
	    ...
	    ///////////////////////FUNCIONES CREADAS POR guillermo\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
